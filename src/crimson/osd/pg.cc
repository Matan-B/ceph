  ...
  FailureFunc&& failure_func)
{
  ...
  return interruptor::do_for_each(ops, [ox](OSDOp& osd_op) {
    ...
    */
    ...
    OpsExecuter::interruptible_future<std::pair<seastar::future<>,do_osd_ops_iertr::future<Ret> > > pre_all_completed_fut =
    _pre_all_completed_fut.safe_then_interruptible([success_func=std::move(success_func)] {
        return success_func();
      ...
      //  ).then_interruptible([] {
          ...
          return seastar::make_ready_future<std::pair<seastar::future<>,
  ...
  return pre_all_completed_fut.then_interruptible([submitted_fut = std::move(submitted_fut)] (auto fut_pair) mutable {
